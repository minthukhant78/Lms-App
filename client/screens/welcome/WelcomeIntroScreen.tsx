     ...
     <LinearGradient
        ...
        >
            <View style = {{marginTop:80, }}>
                ...
                <Text style = {[commonStyles.description, {fontFamily :"Nunito_400Regula"}]}> {item.description}</Text>
                <Text style = {[commonStyles.description, {fontFamily :"Nunito_400Regula"}]}> {item.sortDescrition}</Text>
                <Text style = {[commonStyles.description, {fontFamily :"Nunito_400Regula"}]}> {item.sortDescrition2}</Text>
